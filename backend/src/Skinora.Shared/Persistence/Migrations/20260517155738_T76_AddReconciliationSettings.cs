    ...
    public partial class T76_AddReconciliationSettings : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("0aa51010-0000-0000-0000-000000000037"), "Monitoring", new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "string", "Reconciliation karşılaştırması için hot wallet Tron adresi. NULL ise hot wallet kapsamı atlanır (warn log). Production deploy bu değeri ayarlamalıdır (05 §3.3).", "reconciliation.hot_wallet_address", new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, null },
                    { new Guid("0aa51010-0000-0000-0000-000000000038"), "Monitoring", new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "string", "Reconciliation karşılaştırması için cold wallet Tron adresi (opsiyonel). NULL ise cold wallet kapsamı atlanır (info log). MVP'de cold transfer manuel başlatılır — ColdWalletTransfer ledger'a eşleştirilir.", "reconciliation.cold_wallet_address", new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, null }
                });
        }
