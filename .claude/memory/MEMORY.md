...
- **Implementation:** **F1 Gate Check ✓ PASS** (2026-04-20, PR #44 squash `b37f484`, tag `phase/F1-pass`). T01-T28 + T11.1 + T11.2 + T11.3 tümü ✓. **F2 aktif: T29 ✓ PASS + T30 ✓ PASS (2026-04-21).** Sırada T31 (Steam re-verify + authenticator kontrolü).
...
- **Next:** **T31** (Steam re-verify + authenticator kontrolü — `POST /auth/steam/re-verify`, `GET /auth/steam/re-verify/callback`, `POST /auth/check-authenticator`; 07 §4.6–§4.8, 08 §2.2).
