...
- **Implementation:** **F1 Gate Check ✓ PASS** (2026-04-20, PR #44 squash `b37f484`, tag `phase/F1-pass`). T01-T28 + T11.1 + T11.2 + T11.3 tümü ✓. **F2 başladı: T29 ✓ PASS (re-doğrulama 2026-04-21).** Sırada T30 (ToS kabul, yaş gate, geo-block).
