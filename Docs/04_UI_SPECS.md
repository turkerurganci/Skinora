...
| Steam hesabı kısıtlı (limited) | "Steam hesabınız kısıtlı. Steam, hiç harcama yapmamış hesapların takas yapmasına izin vermiyor; en az 5 USD tutarında bir alışveriş bu engeli kaldırır." Gün sayısı **gösterilmez** — engel beklemekle değil harcamayla biter (02 §9.1a, 08 §2.2a) |
| Steam hesabı 15 günden yeni | "Steam, yeni hesapların ilk 15 gün takas yapmasına izin vermiyor. **Kalan süre: N gün.**" N sunucudan gelir (`steamAccountRemainingDays`, 07 §7.3); alan gelmezse sayısız metin gösterilir |
| Steam'e sorulamadı | "Takas uygunluğunuz Steam üzerinden doğrulanamadı. Bu geçici bir durum — biraz sonra tekrar deneyin." Kalıcı ret gibi gösterilmez (02 §9.1a) |

> **Not:** Bu üç satır engeli **form açılmadan** gösterir. Aynı üç kod `POST /transactions` yanıtından da dönebilir (07 §7.2) ve adım 4 hata panelinde kendi metinleriyle gösterilir — gün sayısı orada taşınmaz, çünkü kapı geçildikten sonra bir hesap "15 günden yeni" durumuna geri **düşemez**; o yolda ulaşılabilen tek Steam reddi kısıtlı hesaptır.
...
*Skinora — UI Specifications v4.6*
