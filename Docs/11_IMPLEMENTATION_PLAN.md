...
Task T138: E2E spec'lerinin yeniden yazımı
  ...
  yerine ölçülen gerçek dağılım; kanıt CI run 32044914807, rapor T137a_REPORT):
    - **7 spec yeniden yazıldı** (20 test) — akışları emekli custody
      durumlarına dayanıyor, hepsi bugün `ACCEPTED`'da takılıyor:
