...
>
> **Durum (2026-08-13, T122 ölçümü):** **38 aktif satır** (36 + §9'da 2 yeni: `P2P-InventoryUnauthorizedMapping`, `P2P-SteamRateLimitWindow`) · 59 satır ✅ çözüldü. İkisi de T122'nin canlı Steam ölçümünde çıktı; ayrıca `P2P-FloatVerification`'ın önkoşulu çürütüldü (Game Coordinator gerekmiyor, veri anonim yanıtta mevcut → ⚪'dan 🟡'ye).
>
