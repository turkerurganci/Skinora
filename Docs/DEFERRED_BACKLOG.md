...
>
> **Durum (2026-08-10, T119 denetimi):** **36 aktif satır** (34 + §9'da 2 yeni: `P2P-NonDeliveryAbuseWindow`, `P2P-DeliveryTimeoutWarning`) · 59 satır ✅ çözüldü. İkisi de T119'un 02 §3.1/§13 kapsam denetiminde çıktı: v3.0 teslimat fazını satıcıya devretti, ama fazın **yaptırım** ve **uyarı** bacakları hiçbir F7 görevine bağlı değil.
>
