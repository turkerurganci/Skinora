...
**Enerji kararı — HİBRİT (proje sahibi, 2026-09-16).** Hot cüzdan beklenen günlük taban hacim kadar TRX'i ENERGY için kilitler; kilidin karşılayamadığı her transfer yakar. Ölçülen maliyetler (2026-09-16, TRX 0,336 $, `getEnergyFee` 100 SUN):
...
| Payout enerjisi (64.285 / 130.285) | 6,43–13,03 TRX | 0 (hot cüzdanın kendi kilidi) |
| Bant genişliği — sıcak cüzdanın ücretsiz kotası bittiyse (yakma: yakma parasının gönderimi + payout; hibrit: devretme + geri alma + payout) | ~0,6 TRX | ~0,9 TRX |
