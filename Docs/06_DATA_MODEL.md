...
Tablo seed sırasıyla (`SystemSettingSeed`) listelenir; toplam **67 anahtar**. `Category`, DB kolonudur (07 §9.8'in API lehçesinden daha kaba — eşleme `SystemSettingsCatalog` kodundadır).
