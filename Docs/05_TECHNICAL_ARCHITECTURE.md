...
**Versiyon: v3.3** | **Bağımlılıklar:** `01_PROJECT_VISION.md`, `02_PRODUCT_REQUIREMENTS.md`, `03_USER_FLOWS.md`, `04_UI_SPECS.md`, `10_MVP_SCOPE.md` | **Son güncelleme:** 2026-08-17 (T129 düzeltme turu — sweep tetikleyicisi satırı mutabakat kapısını (`SettlementVerifiedAt NOT NULL ∧ DeliveryReversedAt NULL`) da yazıyor; `ITEM_DELIVERED` state gate'i tek başına depoziti geri alma tespitinden günler önce boşaltırdı.) · 2026-08-16 (T129 — §4.2'de `complete` ve `delivery_reversed` satırları mutabakat kontrolünün **iki taraflı** olduğunu ve kapının payout/sweep üreticilerinde de okunduğunu yazar hâle getirildi. Geçiş kümesi değişmedi.) · 2026-08-10
