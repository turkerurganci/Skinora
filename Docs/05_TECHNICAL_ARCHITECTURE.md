...
| Fallback | Kilit transferin tamamını karşılayamıyorsa ya da devredilen energy depozitte görünmezse → depozite yakacağı TRX gönderilir (kısmi devretme yapılmaz). Plan hiç hesaplanamazsa sabit yedek TRX (`SWEEP_TRX_FALLBACK_SUN`) gönderilir |
