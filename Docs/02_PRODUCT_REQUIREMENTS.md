...
- **Sıcak cüzdanın kendi işletme bakiyesini tutması gerekir (T129 ikinci düzeltme turu).** Mutabakat kontrolü yalnız ödemenin değil, depozitin sıcak cüzdana süpürülmesinin de kapısıdır (05 §3.3 "Sweep tetikleyicisi"): süpürme teslimat anında değil, kontrol geçtikten sonra çalışır. Bu kapı bilinçlidir — mutabakat süresi boyunca iade hâlâ mümkündür ve iade depozit adresinden çıkar, dolayısıyla depozit iadenin çekilebileceği yerde kalmalıdır — ama nakit akışı sonucu vardır: eskiden süpürme teslimatta, ödeme 8 gün sonra olduğu için sıcak cüzdan ilgili depoziti ödeme çıkışından **günler önce** görüyordu ve bu gecikme sıcak cüzdanı kendiliğinden fonluyordu. Artık iki kapı da `SettlementVerifiedAt` olduğu için o ön fonlama yoktur: ödeme, karşılık gelen depozitle **aynı pencerede** ısmarlanır. Fark platformun kendi işletme bakiyesiyle kapatılır; boyutlandırma launch öncesi kontrol listesindedir (DEPLOY_RUNBOOK §I)
