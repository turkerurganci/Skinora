...
**Son güncelleme:** 2026-04-12 (T11.2 yapım chat'i ⏳ — 4 katman uygulandı, validate bekliyor)
...
| T11.2 | CI disiplin savunma katmanları (startup check + pre-push guard + validator kuralı + bitiş kapısı + BYPASS_LOG düzeltme) | ⏳ Devam ediyor | — | — |
