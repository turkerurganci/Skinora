...
|---|---|---|---|
| M2 | T43 (BLOCKED, SPEC_GAP, 2026-05-01) | Composite `reputationScore` (0-5 ölçekli) formülü hiçbir spec dokümanında tanımlı değil: 02 §13 girdileri sayar, 06 §3.1 sadece bileşen `SuccessfulTransactionRate` formülünü verir, 07 §5.1/§5.2/§5.5/§6.x kontratları `4.8` emit eder ama hangi formülle ürettiği yazılı değil; T43 plan kabul kriterleri composite skoru talep etmiyor (kontrat 07 ↔ plan 11 drift). | Proje sahibi karar (önerim A: 02/06'ya formül ekle + T43 plan kabul kriterlerini güncelle + implement). Tetikleyici: F2 Gate Check öncesi karar zorunlu — formül netleşmeden T43 başlamaz, T43 olmadan F2 kapanmaz. |
...
| T43 | User itibar skoru hesaplama | ⛔ BLOCKED (SPEC_GAP) | — | — |
