...
**Son güncelleme:** 2026-04-20 (T27 yapım tamamlandı — 35 performans index'i T18–T25 entity config'lerinde envanterlendi, 06 §5.2'ye SQL Server filtered index `NOT IN` kısıtı notu eklendi, kod değişikliği yok, validate bekliyor)
...
| T27 | Performans index'leri ve filtered index'ler | ⏳ Devam ediyor | — | — |
